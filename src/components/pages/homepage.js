...
const Homepage = ({ recipeLineInfo, onClick }) => {
    ...
    const homemadeClassics = recipeLineInfo[1]
    console.log(homemadeClassics)
    ...
    return (
        <div>
            ...
            <MiniRecipeLine recipes={homemadeClassics} title={"Homemade Classics"} onClick={onClick[3]}></MiniRecipeLine>
            {/*<div>LOREM IPSUM</div>*/}
        </div>
    )
}
